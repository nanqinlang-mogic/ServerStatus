	...
	$.getJSON("json/stats.json", function(result) {
		...
		for (var i = 0; i < result.servers.length; i++) {
			...
			if (result.servers[i].online4) {
				...
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small>Enabled</small>";
			} else {
				TableRow.children["online4"].children[0].children[0].className = "progress-bar progress-bar-danger";
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small>Disabled</small>";
			}

			// Online6
			//if (result.servers[i].online6) {
			//	TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-success";
			//	TableRow.children["online6"].children[0].children[0].innerHTML = "<small>Enabled</small>";
			//} else {
			//	TableRow.children["online6"].children[0].children[0].className = "progress-bar progress-bar-danger";
			//	TableRow.children["online6"].children[0].children[0].innerHTML = "<small>Disabled</small>";
			//}
			...
			if (!result.servers[i].online4 && !result.servers[i].online6) {
				if (server_status[i]) {
					...
					TableRow.children["cpu"].children[0].children[0].innerHTML = "<small>Disabled</small>";
					...
					TableRow.children["memory"].children[0].children[0].innerHTML = "<small>Disabled</small>";
					...
					TableRow.children["hdd"].children[0].children[0].innerHTML = "<small>Disabled</small>";
...
function updateTime() {
	if (!error)
		$("#updated").html("Latest Update: " + timeSince(d));
}
